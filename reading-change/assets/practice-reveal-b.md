...
**The right group is usually not the biggest one.** Book 4 here has only three
groups — of ten, one and one — so the answer had to be the large one. In the
real questions the group you are looking for is often middling in size, and
sometimes small. Picking the biggest will not work.

**Not everyone survives.** Only eight of the fifteen were still in the network
