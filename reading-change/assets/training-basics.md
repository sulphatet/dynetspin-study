...
Each **dot is one person**. People who work closely together are drawn as one
**spiral** — one spiral per group, and a bigger spiral means more people in it.

A spiral is used because it packs a group of any size into one compact shape, so
